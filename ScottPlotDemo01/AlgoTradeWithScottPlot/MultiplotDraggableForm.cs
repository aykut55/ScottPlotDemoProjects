...
{
    public partial class MultiplotDraggableForm : Form
    {
        private FormsPlot formsPlot1;
        private Button btnAddRow;
        private Button btnDeleteRow;

        public MultiplotDraggableForm()
        {
            InitializeComponent();
            SetupMultiplot();
        }
        ...
        private void InitializeComponent()
        {
            ...
            formsPlot1.Padding = new Padding(0, 40, 0, 0);
            formsPlot1.Size = new Size(825, 636);
            formsPlot1.TabIndex = 0;
            // 
            // btnAddRow
            // 
            btnAddRow.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
            btnAddRow.Location = new Point(607, 12);
            ...
            // btnDeleteRow
            // 
            btnDeleteRow.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
            btnDeleteRow.Location = new Point(713, 12);
            btnDeleteRow.Name = "btnDeleteRow";
            btnDeleteRow.Size = new Size(100, 30);
            btnDeleteRow.TabIndex = 2;
            btnDeleteRow.Text = "Delete Plot";
            btnDeleteRow.UseVisualStyleBackColor = true;
            // 
            // MultiplotDraggableForm
            // 
            ClientSize = new Size(825, 636);
            Controls.Add(btnDeleteRow);
            Controls.Add(btnAddRow);
            Controls.Add(formsPlot1);
            Name = "MultiplotDraggableForm";
            Text = "Multiplot with Draggable Subplots";
            ResumeLayout(false);
        }
        ...
        private void SetupMultiplot()
        {
            ...
            formsPlot1.Multiplot.SharedAxes.ShareX(new[] { pricePlot, rsiPlot, volumePlot });
            ...
            customLayout.SetHeights(new float[] { 600, 100, 100 });
